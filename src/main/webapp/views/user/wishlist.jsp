...
List<Wishlist> wlist = wishListService.getListByUserId(u1.getUserId());
	...
	<div class="container">
		<table class="table table-hover">
			...
			for (Wishlist w : wlist) {
				Product p = pService.getProductsByProductId(w.getProductId());
			%>
			<tr class="text-center">
				<td><img src="http://localhost:8080/DoAnCuoiKy/Product_imgs/<%=p.getProductImages()%>"
