...
<body>
	...
	Product product = productService.getProductsByProductId(pid);
	%>
					...
					<form action="../../AddOperationController?pid=<%=pid%>" method="post"
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-md-6 mb-2">
									<label class="form-label"><b>Tỷ lệ chiết khấu</b></label> <input
							...
							<div class="row">
								...
								<div class="col-md-6 mb-2">
									<label class="form-label"><b>Chọn loại danh mục</b></label> <select
