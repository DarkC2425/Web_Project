...
.navbar {
	font-weight: 500;
	background: linear-gradient(109.6deg, rgb(9, 154, 151) 11.2%,
		rgb(255, 99, 0) 91.1%);
}
...
<nav class="navbar navbar-expand-lg custom-color" data-bs-theme="dark">
	...
	<div class="container">
		<a class="navbar-brand"
			href="http://localhost:8080/DoAnCuoiKy/index.jsp"><i
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="nav-link"
					href="http://localhost:8080/DoAnCuoiKy/views/products.jsp"
					role="button" aria-expanded="false"> Sản phẩm </a>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle"
					href="http://localhost:8080/DoAnCuoiKy/views/#" role="button"
					data-bs-toggle="dropdown" aria-expanded="false"> Danh mục </a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item"
							href="http://localhost:8080/DoAnCuoiKy/views/products.jsp?category=0">Tất
								cả sản phẩm</a></li>
						<%
			...
			<form class="d-flex pe-5" role="search"
				action="http://localhost:8080/DoAnCuoiKy/views/products.jsp"
				method="get">
				<input name="search" class="form-control me-2" size="50"
					type="search" placeholder="Tìm kiếm cho sản phẩm"
			...
			<div class="container">
				<a class="navbar-brand"
					href="http://localhost:8080/DoAnCuoiKy/views/admin/admin.jsp"><i
					class="fa-sharp fa-solid fa-house" style="color: #ffffff;"></i>&ensp;Mangage</a>
					...
					<div class="container text-end">
						<ul class="navbar-nav justify-content-end">
							...
							<li class="nav-item"><a class="nav-link" aria-current="page"
								href="http://localhost:8080/DoAnCuoiKy/views/admin/admin.jsp"><%=admin.getName()%></a></li>
							<li class="nav-item"><a class="nav-link" aria-current="page"
								href="http://localhost:8080/DoAnCuoiKy/LogoutController?user=admin"><i
									class="fa-solid fa-user-slash fa-sm" style="color: #aaf9ff;"></i>&nbsp;Đăng
									xuất</a></li>
						</ul>
					</div>
				</div>
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item active pe-3"><a
					...
					href="http://localhost:8080/DoAnCuoiKy/views/user/cart.jsp"><i
				...
				<li class="nav-item active pe-3"><a class="nav-link"
					aria-current="page"
					href="http://localhost:8080/DoAnCuoiKy/views/user/profile.jsp"><%=user.getUserName()%></a></li>
				<li class="nav-item pe-3"><a class="nav-link"
					aria-current="page"
					href="http://localhost:8080/DoAnCuoiKy/LogoutController?user=user"><i
						class="fa-solid fa-user-slash" style="color: #aaf9ff;"></i>&nbsp;Đăng
						xuất</a></li>
			</ul>
			<%
			} else {
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item active pe-2"><a class="nav-link"
					aria-current="page" href="register.jsp"> <i
						class="fa-solid fa-user-plus" style="color: #aaf9ff;"></i>&nbsp;Đăng
						ký
				</a></li>
				<li class="nav-item pe-2"><a class="nav-link"
					aria-current="page"
					href="http://localhost:8080/DoAnCuoiKy/views/login.jsp"><i
						class="fa-solid fa-user-lock" style="color: #aaf9ff;"></i>&nbsp;Đăng
						nhập</a></li>
<!-- 				<li class="nav-item pe-2"><a class="nav-link"
					aria-current="page"
					href="http://localhost:8080/DoAnCuoiKy/views/admin/adminlogin.jsp">&nbsp;Admin</a></li> -->
			</ul>
	...
	<div class="modal fade" id="add-category" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form
					action="http://localhost:8080/DoAnCuoiKy/AddOperationController"
					...
					<div class="modal-body">
						...
						<div class="mb-3">
							<label class="form-label"><b>Tên danh mục</b></label> <input
								...
								placeholder="Nhập tên danh mục ở đây" class="form-control"
								required>
						</div>
						<div class="mb-3">
							<label for="formFile" class="form-label"><b>Ảnh danh
									mục</b></label> <input class="form-control" type="file" name="category_img"
								id="formFile">
						</div>
					</div>
	...
	<div class="modal fade" id="add-product" tabindex="-1"
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form
					action="http://localhost:8080/DoAnCuoiKy/AddOperationController"
					method="post" name="addProductForm" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-2">
								<label class="form-label"><b>Chọn thể loại danh mục</b></label>
