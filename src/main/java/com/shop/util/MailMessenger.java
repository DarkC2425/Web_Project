...
public class MailMessenger {
	...
	public static void successfullyRegister(String userName, String userEmail) {
		...
		String subject = "Chào mừng bạn đến với 2NTSHOP - Đăng ký thành công!";
		String body = "Xin chào " + userName
				+ ",<p>Xin chúc mừng và chào mừng nồng nhiệt đến với 2NTSHOP! Chúng tôi rất vui mừng khi có bạn là một phần của cộng đồng đang phát triển của chúng tôi. Cảm ơn bạn đã chọn chúng tôi cho nhu cầu mua sắm trực tuyến của bạn.</p>"
				+ "<p>Đăng ký của bạn đã thành công và chúng tôi vui mừng thông báo với bạn rằng bạn hiện là thành viên quan trọng trên nền tảng của chúng tôi. Với 2NTSHOP, bạn sẽ khám phá nhiều lựa chọn sản phẩm và ưu đãi thú vị phù hợp với sở thích và sở thích của bạn."
		...
		try {
			SendMailService.sendMail(userEmail, subject, body);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static void successfullyOrderPlaced(String userName, String userEmail, String orderId, String OrderDate) {
		...
		String body = "Xin chào " + userName
				+ ",<p>Chúng tôi vui mừng thông báo với bạn rằng đơn hàng của bạn đã được đặt thành công và hiện đang được xử lý. Cảm ơn bạn đã lựa chọn 2NTSHOP cho nhu cầu mua sắm của mình!</p>"
				...
				+ "<p>Cảm ơn bạn đã mua sắm với chúng tôi! Sự tin tưởng của bạn vào <b>2NTSHOP</b> có ý nghĩa rất lớn đối với chúng tôi và chúng tôi hứa sẽ mang đến cho bạn trải nghiệm mua sắm đặc biệt.</p>";
		try {
			SendMailService.sendMail(userEmail, subject, body);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void orderShipped(String userName, String userEmail, String orderId, String OrderDate) {
		...
		String body = "Xin chào " + userName
				+ "<p>Lời chào từ <b>2NTSHOP</b>! Chúng tôi vui mừng thông báo với bạn rằng đơn hàng của bạn đang trên đường đến tay bạn. Gói hàng của bạn đã được vận chuyển thành công và sẽ sớm đến trước cửa nhà bạn!</p>"
				...
				+ "<p>Một lần nữa chúng tôi đánh giá cao sự tin tưởng của bạn đối với <b>2NTSHOP</b> cho nhu cầu mua sắm của bạn. Chúng tôi mong muốn mang đến cho bạn trải nghiệm mua sắm vượt trội và sự hài lòng của bạn là ưu tiên hàng đầu của chúng tôi.</p>"
